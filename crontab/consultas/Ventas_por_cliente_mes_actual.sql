...
F.id_cliente, ROUND(SUM(IF(F.id_serie=6,-1*F.total_bruto,F.total_bruto)),2) as Total_bruto, 
...
GROUP BY SF.id_serie,C.id_cliente ORDER BY SF.id_serie desc,C.nombre
